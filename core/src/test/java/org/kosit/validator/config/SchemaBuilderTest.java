...
public class SchemaBuilderTest {
    ...
    public void testBuildSchema() {
        ...
        final SingleProcessingResult<Pair<ValidateWithXmlSchema, Schema>, String> result = builder.build(Simple.createContentRepository());
    ...
    public void testPrecompiled() {
        ...
        final SingleProcessingResult<Pair<ValidateWithXmlSchema, Schema>, String> result = builder.build(repository);
        assertThat(result).isNotNull();
        assertThat(result.isValid()).isTrue();
    }
}

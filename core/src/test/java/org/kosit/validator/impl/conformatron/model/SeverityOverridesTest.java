...
/**
 * Tests {@link SeverityOverrides}: the customLevel semantics carried over from 1.x (token lists, both directions, level
 * mapping into the severity model).
 */
public class SeverityOverridesTest {
    ...
    public void testTokenListsExpandToOneOverridePerCode() {
        final SeverityOverrides overrides = SeverityOverrides

...
| error | `target-non-conformant` | Target 'EN16931 XRechnung Extension (CII)' non-conformant: 4 error detection(s) from rule set 'resources/cii/16b/xsl/EN16931-CII-validation.xsl' |

...
| error | `target-non-conformant` | Target 'EN16931 XRechnung Extension (UBL Invoice)' non-conformant: 1 error detection(s) from rule set 'resources/ubl/2.1/xsl/EN16931-UBL-validation.xsl' |

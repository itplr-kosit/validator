...
- (BUILD): Made concept of validator distribution more clear and self-contained within `distribution` module
- (BUILD): Only validator-cli module has additional standalone artifact

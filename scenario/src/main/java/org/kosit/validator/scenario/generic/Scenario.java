 ...
 * <ul>
 * <li>{@link EScenarioKind#XML} uses the namespaces, the match, the XML Schemas, the Schematrons and the accept match.
 * This is the only kind that scenario configuration version 2 knows.</li>
...
public class Scenario {
    ...
    public String toString() {
        return "Scenario[kind=" + this.kind + "; coordinate=" + this.coordinate + "; name=" + this.name + "; description="
                ...
                + "; schematrons=" + this.schematrons + "; acceptMatch=" + this.acceptMatch + "; requirements=" + this.requirements
                + "; xmlScenarioRef=" + this.xmlScenarioRef + "]";
    }
}

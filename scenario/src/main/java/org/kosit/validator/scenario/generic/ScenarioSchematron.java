...
public class ScenarioSchematron {
    ...
    /**
     * @return the modifiable list of all custom error levels of this rule set. Never <code>null</code>.
     */
     ...
     * @return this for chaining
     */
    public @NonNull ScenarioSchematron addCustomLevel(@NonNull final ScenarioCustomErrorLevel customLevel) {
    ...
    public String toString() {
        return "ScenarioSchematron[resource=" + this.resource + "; psvi=" + this.psvi + "; compiler=" + this.compiler + "; customLevels="
                + this.customLevels + "]";
    }
}
